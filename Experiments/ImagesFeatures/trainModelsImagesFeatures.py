...
for cycle in range(num_cycles):
    ...
    dataset = ImageFeatureDataset(all_videos, all_features, all_labels)
    ...
    for name, model in models.items():
        ...
        for batch_images, batch_features, batch_labels in dataloader:
            ...
            if(name == "im_resnet"):
                ...
                predictions = model(batch_images, batch_features)
        ...
        with torch.no_grad():
            ...
            for vid, label_value in zip(val_videosFeatures, val_labels):
                ...
                if not single_prediction:
                    batch_size, num_images, _, _ = val_images.shape
