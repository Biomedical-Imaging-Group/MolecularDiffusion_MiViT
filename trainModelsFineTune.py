...
### Training Settings ###
num_cycles = 1  # Number of dataset refreshes
...
for cycle in range(num_cycles):
    ...
    train_d_in_order = np.arange(0.01, 7.001, 0.01)

    for D in val_d_in_order:
        trajs, labels = models_phenom().single_state(N_in_order, 
                                        L = 0,
                                        T = T,
    ...
    dataloader = DataLoader(dataset, batch_size=len(train_d_in_order), shuffle = mix_trajectories or shuffle)
